...
- The current shared command catalog is `36/36` after Phase 5 Plan 05-11
  adds the parity-closed `MoveField` extension; this later Phase 5 extension
  does not rewrite the historical Phase 2 baseline of `33/33`.
