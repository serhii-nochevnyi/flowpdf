...
impl AuditCommandKind {
    ...
    pub fn from_transaction_type(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "setInlineMarks" => Self::SetInlineMarks,
            "setInlineMark" => Self::SetInlineMark,
            "setBlockAttributes" => Self::SetBlockAttributes,
            "setBlockStyle" => Self::SetBlockStyle,
            "setListKind" => Self::SetListKind,
            "continueListItem" => Self::ContinueListItem,
            "exitListItem" => Self::ExitListItem,
            "indentListItem" => Self::IndentListItem,
            "outdentListItem" => Self::OutdentListItem,
            "insertPageBreak" => Self::InsertPageBreak,
            "removePageBreak" => Self::RemovePageBreak,
            "insertTable" => Self::InsertTable,
            "insertImage" => Self::InsertImage,
            "replaceImage" => Self::ReplaceImage,
            "setImageAccessibility" => Self::SetImageAccessibility,
            "removeImage" => Self::RemoveImage,
            "addTableRow" => Self::AddTableRow,
            "removeTableRow" => Self::RemoveTableRow,
            "addTableColumn" => Self::AddTableColumn,
            "removeTableColumn" => Self::RemoveTableColumn,
            "setTableHeaderRow" => Self::SetTableHeaderRow,
            "removeTable" => Self::RemoveTable,
            "insertField" => Self::InsertField,
            "setField" => Self::SetField,
            "removeField" => Self::RemoveField,
            "moveField" => Self::MoveField,
            "batch" => Self::Batch,
            "undo" => Self::Undo,
            "redo" => Self::Redo,
            _ => return None,
...
impl AuditErrorCode {
    ...
    pub const fn code(&self) -> &'static str {
        match self {
            ...
            Self::ListDepthLimit => "FLOW_LIMIT_LIST_DEPTH",
    ...
    pub fn from_stable_code(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "FLOW_INVALID_FORMATTING" => Self::InvalidFormatting,
            "FLOW_INVALID_LIST_STRUCTURE" => Self::InvalidListStructure,
            "FLOW_LIMIT_LIST_DEPTH" => Self::ListDepthLimit,
