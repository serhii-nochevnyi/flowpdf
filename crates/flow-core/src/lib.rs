...
pub use pdf::{
    ...
    MAX_PDF_METADATA_FIELD_BYTES, MAX_PDF_OUTLINE_ENTRIES, MAX_PDF_OUTPUT_BYTES,
    MAX_PDF_SOURCE_PAYLOAD_BYTES, MAX_PDF_SOURCE_STREAM_BYTES, PDF_DISPLAY_LIST_SCHEMA_VERSION,
    PDF_EXPORT_SCHEMA_VERSION, PDF_EXTERNAL_SOURCE_HASH_PREFIX, PDF_FORM_SCHEMA_VERSION,
    PDF_PROVENANCE_SCHEMA_VERSION, PDF_READER_SCHEMA_VERSION, PDF_RECONSTRUCTION_SCHEMA_VERSION,
    ...
    PdfDisplayPage, PdfDocumentCandidate, PdfDocumentSummary, PdfError, PdfExportManifest,
    PdfExportOptions, PdfExportRequest, PdfExportResult, PdfFontError, PdfFontManifestIdentity,
    PdfFontResource, PdfFormElement, PdfFormError, PdfFormField, PdfFormFieldType, PdfFormOption,
    PdfFormPlan, PdfFormValue, PdfGlyph, PdfGlyphPlacement, PdfImageElement, PdfImageEncoding,
    PdfImageError, PdfImageItem, PdfImageResource, PdfInternalLink, PdfLinkElement,
    PdfManifestOptions, PdfMappingOrigin, PdfMetadataError, PdfMetadataOptions, PdfName,
    PdfObjectRef, PdfOcrCandidate, PdfOpaqueIsland, PdfOpaqueIslandKind, PdfOutlineEntry,
    PdfPageContent, PdfPagePlan, PdfPathCommand, PdfPathElement, PdfProvenanceError,
    PdfReadDiagnostic, PdfReadDiagnosticCode, PdfReadError, PdfReadReport, PdfReadSeverity,
    PdfReader, PdfReaderLimits, PdfReconstructedBlock, PdfReconstructionDiagnostic,
    PdfReconstructionDiagnosticCode, PdfReconstructionError, PdfReconstructionReport,
    PdfReconstructionRequest, PdfReconstructionResult, PdfRecoveredSource, PdfRecoveryError,
    PdfRecoveryExpectation, PdfRef, PdfReproducibilityInputs, PdfReviewAction, PdfReviewDecision,
    PdfScene, PdfSceneElement, PdfScenePage, PdfSceneRequest, PdfSourceMapping,
    PdfSourceProvenance, PdfSubsetGlyph, PdfSupportReport, PdfSupportedFeature, PdfTextElement,
    PdfTextItem, PdfTextLine, PdfTextMapping, PdfUnsupportedFeature, accept_pdf_reconstruction,
    build_display_list, build_font_resources, build_image_resources, build_pdf_form_plan,
    export_pdf, open_pdf, read_pdf_scene, reconstruct_pdf_scene, recover_owned_source,
...
const fn audit_command_kind(kind: &CommandKind) -> AuditCommandKind {
    match kind {
        ...
        CommandKind::MoveField { .. } => AuditCommandKind::MoveField,
